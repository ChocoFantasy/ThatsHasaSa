...
const Characters = () => {
  ...
  const characters = [
    {
      ...
      tagline: "「創造的力量」",
      description:
        "充滿好奇心的一粒黑色砂粒，像砂礫一樣堅毅，勇於嘗試各種事物，喜愛藝術，也象徵著將細小的砂粒匯聚成無限創造力。",
      faction: "創意之心",
      quotes: [
        "讓我們一起創造奇蹟！",
        "藝術是心靈的力量。",
    ...
    },
    {
      ...
      tagline: "「大自然的療癒者」",
      description:
        "一顆喜歡大自然的蛤蜊，熱愛植物、海洋和所有令人療癒的事物。粒粒較少說話，總能靜靜地觀察並理解人心，給予夥伴們溫暖與支持，是最值得信賴的好夥伴。",
      faction: "自然守護者",
      quotes: [
        "大自然是心靈的療癒。",
        "海風吹在身上，真是涼爽。",
    ...
    },
    {
      ...
      tagline: "「閃耀的夢」",
      description:
        "一隻藍色的浣熊，懷抱著成為偶像的夢想，擁有閃閃發亮的偶像眼睛。平時懶懶的，常因遇到挫折而抱怨，但內心始終充滿熱情與堅持，喜歡唱歌且對喜愛的事物執著。",
      faction: "星光之夢",
      quotes: [
        "每個努力的日子，都是閃耀的時刻。",
        "不要碰我的垃圾。",
    ...
    },
    {
      ...
      tagline: "「音樂與科技的智者」",
      description:
        "一隻愛好音樂的熊，頭戴耳機，擅長DJ盤和各種科技設備。貝陸博學多聞，像一本百科全書，總能回答夥伴們的疑問，是團隊中不可或缺的智者。",
      faction: "音律與智慧",
      quotes: [
        "科技讓我們更接近未來。",
        "任何問題，都有解決之道！",
    ...
    },
    {
      ...
      tagline: "「快樂的料理家」",
      description:
        "一隻灰色的雞，頭頂深藍色毛髮，熱愛美食與料理，是團隊中最會做菜的角色。亞雞擅長用幽默的語氣化解氣氛，懂得許多梗圖，帶給大家快樂與溫暖。",
      faction: "美味與快樂",
      quotes: [
        "人生就是一場美味的盛宴！",
        "想吃什麼，馬上做給你吃",
    ...
    },
    {
      ...
      tagline: "「熱血的戰士」",
      description:
        "一隻紅色的刺蝟，頭戴護目鏡，充滿熱情與正義感，總能和所有人打成一片。在實驗室裡，他專注於研究科技機械，表面熱情，內心對事情認真執著，是團隊裡最年輕但最有衝勁的一員。",
      faction: "熱血發明家",
      quotes: [
        "交朋友？簡單的事！",
        "熱血，就是我的動力！",
  ...
  return (
    <div
      ...
      style={{
        backgroundColor:
          currentCharacter.theme.contrast === "black" ? "#ffffff" : "#1a1a1a",
        "--character-primary": currentCharacter.theme.primary,
        "--character-primary-transparent":
      ...
      >
        ...
        >
          ...
          <div className="info-grid">
            <div className="info-block faction">{currentCharacter.faction}</div>
            ...
            <div className="info-block quotes">
              ...
              {/* 印章圖片 - 動態更換 */}
              <div className="character-seal">
                <img
                  src={currentCharacter.sealImage} // 動態傳入圖片路徑
                  alt={`${currentCharacter.name} Seal`}
                />
              </div>
            </div>
          </div>
        ...
        {characters.map((char, index) => (
          <button
            ...
            className={`selector-button ${
              selectedCharacter === index ? "active" : ""
            }`}
            style={{
